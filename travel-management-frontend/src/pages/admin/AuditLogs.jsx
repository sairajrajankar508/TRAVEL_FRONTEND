  ...
  return (
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-7 border-b border-slate-200 flex justify-between items-center">
...
const StatCard = ({
  ...
  <div className="bg-white rounded-3xl shadow-lg border border-slate-200 p-6 hover:shadow-2xl transition">
    ...
    <div className="flex justify-between items-center">
      ...
      <div
        className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl bg-${color}-100 text-${color}-700`}
      >
        {icon}
      </div>
...
const RoleCard = ({
  ...
  <div
    className={`flex items-center justify-between rounded-2xl p-5 border bg-${color}-50 border-${color}-100`}
  >

    <div className="flex items-center gap-4">

      <div
        className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl bg-${color}-100 text-${color}-700`}
      >
        {icon}
      </div>
    ...
    <h2
      className={`text-3xl font-bold text-${color}-700`}
    >
      {count}
    </h2>
