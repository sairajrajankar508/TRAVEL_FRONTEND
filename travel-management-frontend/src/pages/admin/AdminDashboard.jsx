        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-gray-500 mt-2">
                    ...
                    Travel Management System Overview
    ...
    return (
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6 border border-slate-100 hover:shadow-2xl transition">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className={`w-16 h-16 rounded-2xl ${bg} flex items-center justify-center ${color} text-3xl`}>
...
function StatusItem({
    ...
    return (
        ...
        <div className={`flex justify-between items-center ${bg} p-4 rounded-2xl`}>
