        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-2">
              ...
              Configure travel budgets, travel classes and policy rules
          ...
          <button
            ...
            className="flex items-center gap-3 bg-linear-to-r from-cyan-600 to-blue-700 hover:scale-105 transition-all text-white px-6 py-3 rounded-2xl shadow-lg font-semibold"
          >
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div className="p-7 border-b border-slate-200">
          ...
          <p className="text-slate-500 mt-1">
            ...
            Manage all travel policy configurations
                ...
                policies.map((policy) => (
                  ...
                  >
                    ...
                    <td className="p-5 text-center">
                      ...
                      <div className="flex items-center justify-center gap-3 font-bold text-slate-700 text-lg">
